...
def restart():
    if "SUZUKI_DO_NOT_RESTART" in os.environ:
        print(
            ...
            " packages and then restart Suzuki. Run `pip uninstall -y telethon"
            " telethon-mod suzuki-tl pyrogram suzuki-pyro`, then restart Suzuki."
        )
        sys.exit(0)
    ...
    os.environ["SUZUKI_DO_NOT_RESTART"] = "1"
