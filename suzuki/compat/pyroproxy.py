...
import suzuki_tl
from suzuki_pyro import Client as PyroClient
from suzuki_pyro import errors as pyro_errors
from suzuki_pyro import raw
...
PROXY = {
    pyro_object: suzuki_tl.tl.alltlobjects.tlobjects[constructor_id]
    for constructor_id, pyro_object in raw.all.objects.items()
    if constructor_id in suzuki_tl.tl.alltlobjects.tlobjects
}
...
REVERSED_PROXY = {
    ...
    **{
        ...
        for _, tl_object in utils.iter_attrs(suzuki_tl.tl.custom)
...
class PyroProxyClient(PyroClient):
    ...
    def __init__(self, tl_client: CustomTelegramClient):
        ...
        super().__init__(
            ...
            lang_code="en",
            in_memory=True,
            phone_number=tl_client.suzuki_me.phone,
        )
    ...
    def _on_event(
        self,
        event: typing.Union[
            suzuki_tl.tl.types.Updates,
            suzuki_tl.tl.types.UpdatesCombined,
            suzuki_tl.tl.types.UpdateShort,
        ],
    ):
    ...
    async def invoke(
        ...
        **kwargs,
        ...
        except suzuki_tl.errors.rpcerrorlist.RPCError as e:
    ...
    @staticmethod
    def _tl_error2pyro(
        error: suzuki_tl.errors.rpcerrorlist.RPCError,
    ...
    def _pyro2tl(self, pyro_obj: raw.core.TLObject) -> suzuki_tl.tl.TLObject:
        """
    ...
    def _tl2pyro(self, tl_obj: suzuki_tl.tl.TLObject) -> raw.core.TLObject:
        """
        ...
        if (
            ...
            tl_obj.from_id = suzuki_tl.tl.types.PeerUser(tl_obj.sender_id)
        ...
        if not isinstance(tl_obj, suzuki_tl.tl.TLObject):
            return tl_obj
    ...
    async def resolve_peer(
        ...
        *args,
        **kwargs,
    ) -> "typing.Union[suzuki_pyro.raw.types.PeerChat, suzuki_pyro.raw.types.PeerChannel, suzuki_pyro.raw.types.PeerUser]":  # type: ignore  # noqa: E501, F821
        """
        ...
        :rtype: typing.Union[suzuki_pyro.raw.types.PeerChat, suzuki_pyro.raw.types.PeerChannel, suzuki_pyro.raw.types.PeerUser]
        """
