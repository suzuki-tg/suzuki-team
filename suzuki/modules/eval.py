...
import suzukitl
from suzukitl.errors.rpcerrorlist import MessageIdInvalidError
from suzukitl.sessions import StringSession
from suzukitl.tl.types import Message
from meval import meval

from .. import loader, main, utils
from ..log import SuzukiException
...
class Evaluator(loader.Module):
    ...
    async def e(self, message: Message):
        try:
            ...
            item = SuzukiException.from_exc_info(*sys.exc_info())
    ...
    def censor(self, ret: str) -> str:
        ret = ret.replace(str(self._client.suzuki_me.phone), "&lt;phone&gt;")
        ...
        if btoken := self._db.get("suzuki.inline", "bot_token", False):
            ret = ret.replace(
                btoken,
                f'{btoken.split(":")[0]}:{"*" * 26}',
            )
    ...
    async def getattrs(self, message: Message) -> dict:
        ...
        return {
            ...
            "reply": reply,
            "r": reply,
            **self.get_sub(suzuki.tl.types),
            **self.get_sub(suzuki.tl.functions),
            "event": message,
            "chat": message.to_id,
            "suzuki": suzuki,
            "telethon": suzuki,
                ...
                itertools.chain.from_iterable(
                    [
                        ...
                        for y in filter(
                            ...
                            and x[1] != obj
                            and x[1].__package__.rsplit(".", _depth)[0] == "suzuki.tl",
                            obj.__dict__.items(),
                        )
                    ]
                )
