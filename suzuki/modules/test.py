...
class TestMod(loader.Module):
        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " Suzuki will try to determine, which client caused logs. E.g. there"
                    ...
                    " Suzuki will send all logs to Client1 and Client2, even if it is"
    ...
    async def logs(
        ...
        other = (
            *main.__version__,
            (
                " <a"
                f' href="https://github.com/suzuki-team/Suzuki/commit/{ghash}">@{ghash[:8]}</a>'
                if ghash
                else ""
            ),
        )
    ...
    async def client_ready(self):
        chat, _ = await utils.asset_channel(
            self._client,
            "suzuki-logs",
            "🚗 Your Suzuki logs will appear in this chat",
            silent=True,
            invite_bot=True,
            avatar="https://github.com/suzuki-team/assets/raw/master/suzuki-logs.png",
        )
