...
from suzukitl.errors.rpcerrorlist import YouBlockedUserError
from suzukitl.tl.functions.contacts import UnblockRequest
...
class InlineStuff(loader.Module):
    ...
    @loader.command()
    async def ch_suzuki_bot(self, message: Message):
        ...
        self._db.set("suzuki.inline", "custom_bot", args)
        self._db.set("suzuki.inline", "bot_token", None)
    ...
    async def aiogram_watcher(self, message: BotInlineMessage):
        ...
        await message.answer_photo(
            "https://github.com/suzuki-team/assets/raw/master/suzuki_banner.png",
            caption=self.strings("this_is_suzuki"),
        )