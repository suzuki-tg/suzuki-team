...
@loader.tds
class SuzukiInfoMod(loader.Module):
    """Show userbot info"""

    strings = {"name": "SuzukiInfo"}
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "custom_button",
                ["🚗 Support chat", "https://t.me/suzuki_talks"],
    ...
    def _render_info(self, inline: bool) -> str:
        ...
        me = '<b><a href="tg://user?id={}">{}</a></b>'.format(
            self._client.suzuki_me.id,
            utils.escape_html(get_display_name(self._client.suzuki_me)),
        )
        ...
        return (
            (
                "<b>🚗 Suzuki</b>\n"
                if "suzuki" not in self.config["custom_message"].lower()
                else ""
            )
                ...
                *map(
                    ...
                    (
                        (
                            ...
                            if self._client.suzuki_me.premium and not inline
                            else "🚗 Suzuki"
                        ),
    ...
    @loader.inline_handler(
        thumb_url="https://img.icons8.com/color/344/car--v1.png"
    )
    ...
    async def info(self, _: InlineQuery) -> dict:
        ...
        return {
            ...
            **(
            ...
            "thumb": (
                "https://github.com/suzuki-team/Suzuki/raw/master/assets/suzuki_pfp.png"
            ),
    ...
    @loader.command()
    async def suzukiinfo(self, message: Message):
