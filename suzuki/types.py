...
from suzukitl.tl.functions.account import UpdateNotifySettingsRequest
...
SuzukiReplyMarkup = typing.Union[typing.List[typing.List[dict]], typing.List[dict], dict]
...
class Module:
    ...
    @property
    def suzuki_commands(self) -> typing.Dict[str, Command]:
        """List of commands that module supports"""
        return get_commands(self)
    ...
    @property
    def suzuki_inline_handlers(self) -> typing.Dict[str, Command]:
        """List of inline handlers that module supports"""
        return get_inline_handlers(self)
    ...
    @property
    def suzuki_callback_handlers(self) -> typing.Dict[str, Command]:
        """List of callback handlers that module supports"""
        return get_callback_handlers(self)
    ...
    @property
    def suzuki_watchers(self) -> typing.Dict[str, Command]:
        """List of watchers that module supports"""
        return get_watchers(self)
    ...
    @suzuki_commands.setter
    def suzuki_commands(self, _):
        pass
    ...
    @suzuki_inline_handlers.setter
    def suzuki_inline_handlers(self, _):
        pass
    ...
    @suzuki_callback_handlers.setter
    def suzuki_callback_handlers(self, _):
        pass
    ...
    @suzuki_watchers.setter
    def suzuki_watchers(self, _):
        pass
    ...
    async def animate(
        ...
        *,
        ...
        with contextlib.suppress(AttributeError):
            _suzuki_client_id_logging_tag = copy.copy(self.client.tg_id)  # noqa: F841
    ...
    async def _decline(
        ...
        self._db.set(
            "suzuki.main",
            "declined_joins",
            list(set(self._db.get("suzuki.main", "declined_joins", []) + [channel.id])),
        )
        event.status = False
        event.set()
        await call.edit(
    ...
    async def request_join(
        ...
        if channel.id in self._db.get("suzuki.main", "declined_joins", []):
            if assure_joined:
                raise LoadError(
        ...
        self.suzuki_wait_channel_approve = (
            self.__class__.__name__,
            channel,
            reason,
        )
        ...
        with contextlib.suppress(AttributeError):
            delattr(self, "suzuki_wait_channel_approve")
    ...
    async def import_lib(
        ...
        *,
        ...
        if re.search(r"# ?scope: ?suzuki_min", code):
            ver = tuple(
                map(
                    int,
                    re.search(r"# ?scope: ?suzuki_min ((\d+\.){2}\d+)", code)[1].split(
                        "."
                    ),
                )
            )
            ...
            if version.__version__ < ver:
                _raise(
                    RuntimeError(
                        f"Library requires Suzuki version {'{}.{}.{}'.format(*ver)}+"
                    )
                )

        module = f"suzuki.libraries.{url.replace('%', '%%').replace('.', '%d')}"
        ...
        if (
            ...
            and self._db.get("suzuki.main", "stats", True)
            and url is not None
...
class DragonModule:
    ...
    def __init__(self):
        ...
        self.commands = {}
        self.watchers = {}
        self.suzuki_watchers = {}
        self.inline_handlers = {}
        self.suzuki_inline_handlers = {}
        self.callback_handlers = {}
        self.suzuki_callback_handlers = {}
