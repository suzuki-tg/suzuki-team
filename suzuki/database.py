...
from suzuki_tl.errors.rpcerrorlist import ChannelsTooMuchError
from suzuki_tl.tl.types import Message, User
    ...
    async def init(self):
        ...
        try:
            self._assets, _ = await utils.asset_channel(
                self._client,
                "suzuki-assets",
                "🌆 Your Suzuki assets will be stored here",
                archive=True,
                avatar="https://raw.githubusercontent.com/suzuki-team/assets/master/suzuki-assets.png",
            )
